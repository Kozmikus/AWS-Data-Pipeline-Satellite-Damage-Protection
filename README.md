...
**Specifics**:
- **GitHub Copilot** was used to assist in writing down the results of `Athena` queries in markdown table format quickly, found in the `Results of Query Analysis.md` file.
